...
public class Input {
	...
	/** */
	public static final int KEY_MINUS           = 0x0C; /* - on shadowbuild.Main keyboard */
	/** */
	...
	/** */
	public static final int KEY_RETURN          = 0x1C; /* Enter on shadowbuild.Main keyboard */
	/** */
	public static final int KEY_ENTER           = 0x1C; /* Enter on shadowbuild.Main keyboard */
	/** */
	...
	/** */
	public static final int KEY_PERIOD          = 0x34; /* . on shadowbuild.Main keyboard */
	/** */
	public static final int KEY_SLASH           = 0x35; /* / on shadowbuild.Main keyboard */
	/** */
